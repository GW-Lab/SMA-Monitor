...
Public Class Weather : Inherits Dictionary(Of String, Device)
   Public TempCurrent As DataLog
   ...
   Public Sub New(dataloglistvalidlogs As List(Of DataLogListValidLogsJSON.Values), iBase As IungoBase)
      Me.TempCurrent = New DataLog(dataloglistvalidlogs.First(Function(log) log.Prop = "temp_current").Oid, "temp_current", iBase)
